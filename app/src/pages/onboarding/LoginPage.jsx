...
export default function LoginPage() {
  ...
  const isValid = form.identifier.length >= 4 && form.password.length >= 1
  ...
  return (
    <div className="auth-layout">
      <div className="auth-topbar">
        <button className="auth-back-btn" onClick={() => navigate('/')} id="login-back">
          <BackIcon /> Back
        </button>
      ...
      <div className="auth-form-screen">
        <form className="auth-form-card" onSubmit={handleSubmit} noValidate>
          ...
          <p className="auth-form-subtitle">Manage your account</p>
          ...
          <div className="field-group">
            ...
            <div className="field-hint">
              <Link
                to="/forgot-password"
                style={{ fontSize: 13, fontWeight: 600, color: '#1A7A2E' }}
