...
export default function RegisterPage() {
  ...
  const isValid = form.identifier.length >= 6 && form.password.length >= 8
  ...
  return (
    <div className="auth-layout">
      ...
      <div className="auth-topbar">
        <button className="auth-back-btn" onClick={() => navigate('/')} id="register-back">
          <BackIcon /> Back
        </button>
      ...
      <div className="auth-form-screen">
        <form className="auth-form-card" onSubmit={handleSubmit} noValidate>
          <h1 className="auth-form-title">Create your Footfrica account</h1>
          <p className="auth-form-subtitle">
            We'll use this to secure your account. You can add more details later.
          </p>
          ...
          <div className="field-group">
            <label className="field-label" htmlFor="reg-identifier">
